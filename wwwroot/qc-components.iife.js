(function(){"use strict";class h extends HTMLElement{static get observedAttributes(){return["label","type","href","class","display","size","icon","icon-position"]}constructor(){super(),this.render()}attributeChangedCallback(e,t,s){t!==s&&this.render()}get template(){const e=this.className?this.className+" "+this.currenttype:this.currenttype+" "+this.currentDisplay;return`
    ...
    `}}customElements.get("qc-footer")||customElements.define("qc-footer",y);class A extends HTMLElement{static get observedAttributes(){return["titre"]}attributeChangedCallback(e,t,s){t!==s&&this.render()}constructor(){super(),this.render()}connectedCallback(){this.render(),this.setupAnchors()}get template(){return`
        ...
        `}render(){this.innerHTML=this.template}get titre(){return this.getAttribute("titre")||"Table des matières"}generateAnchors(){const e=[];return document.querySelectorAll(".tdm").forEach((s,i)=>{const r=s.getAttribute("tdm-titre")||s.textContent.trim(),n=`tdm-anchor-${i}`;s.id=n,e.push(`<li><a href="#${n}" class="tdm-link">${r}</a></li>`)}),e.join("")}setupAnchors(){this.querySelectorAll(".tdm-link").forEach(t=>{t.addEventListener("click",s=>{s.preventDefault();const i=t.getAttribute("href").substring(1),r=document.getElementById(i);r&&r.scrollIntoView({behavior:"smooth"})})})}}customElements.get("qc-tdm")||customElements.define("qc-tdm",A);class k extends HTMLElement{constructor(){super(),this.render()}connectedCallback(){window.addEventListener("scroll",this.toggleVisibility.bind(this)),this.querySelector("qc-bouton").addEventListener("click",this.scrollToTop)}disconnectedCallback(){window.removeEventListener("scroll",this.toggleVisibility.bind(this)),this.querySelector("qc-bouton").removeEventListener("click",this.scrollToTop)}render(){this.innerHTML=`
